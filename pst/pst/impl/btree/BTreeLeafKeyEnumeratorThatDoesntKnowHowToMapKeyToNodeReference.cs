...
namespace pst.impl.btree
{
        ...
        where TNode : class
    {
        ...
        public TLeafKey[] Enumerate(IDataBlockReader<TNodeReference> reader, IReadOnlyDictionary<TIntermediateKey, TNodeReference> keyToNodeReferenceMapping, TNodeReference rootNodeReference)
        {
