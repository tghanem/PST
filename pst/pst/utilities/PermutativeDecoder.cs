...
{
    class PermutativeDecoder : IDecoder<BinaryData>
    {
        private readonly byte[] mpbbCrypt = 
        {
        ...
        public PermutativeDecoder(bool encrypt)
        {
            this.encrypt = encrypt;
        }

        public BinaryData Decode(BinaryData encodedData)
        {
            ...
            {
                decodedData[i] = mpbbCrypt[baseIndex + encodedData.Value[i]];
            }
